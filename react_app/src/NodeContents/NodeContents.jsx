...
const RegenerateSvg = styled.svg`
  ...
  fill: ${props => props.isClickRegenerate ? '#17594A': fontColors[props.themeColorId]};
`
          ...
          {isLoading ? 
            <LoadingScreenArea>
              {Math.floor(Math.random() * 2) === 0 ? 
                <img src="load/loading-bee.gif" alt="loading gif" />
                : <img src="load/loading-leaf.gif" alt="loading gif" />
              }
            </LoadingScreenArea>
            :
            <>
            ...
            <ButtonContainer id='buttons'>
              ...
              : <>
                ...
                <StyledButton id='regenerate'onClick={handleResend} disabled={isRegenerate} themeColorId={themeColorId}>
                  再生成
                  <RegenerateSvg xmlns="http://www.w3.org/2000/svg" width="25" height="25" viewBox="0 0 35 35" isClickRegenerate={isRegenerate} themeColorId={themeColorId}>
                ...
                <StyledButtonGreen id='addQuestion' onClick={handleAddQuestion} disabled={isAddQuestion} themeColorId={themeColorId}>
                  問題を解く
                </StyledButtonGreen>
              </>
            }
